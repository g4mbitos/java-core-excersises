...
public class CrazyLambdas {
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        return (String s, Integer n) -> s.repeat(n);
    }
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        return (BigDecimal amount) -> "$"+amount.toString();
    }
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
        return (String s) -> min <= s.length() && s.length() < max;
    }
    ...
    public static IntSupplier randomIntSupplier() {
        return () -> (int) ThreadLocalRandom.current().nextInt();
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        return (int bound) -> ThreadLocalRandom.current().nextInt(bound);
    }
    ...
    public static LongBinaryOperator longSumOperation() {
        return (long num1, long num2) -> num1 + num2;
    }
    ...
    public static ToIntFunction<String> stringToIntConverter() {
        return (String s) -> Integer.parseInt(s);
    }
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        return  (Function<String, String> f) -> f.compose(String::trim);
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        ...
        return (IntUnaryOperator unaryOperator, IntPredicate predicate) ->
                (int number) -> predicate.test(number) ? unaryOperator.applyAsInt(number) : number;
    }
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
            return (Map<String,IntUnaryOperator> map, String s) ->
                    (int number) -> map.containsKey(s) ? map.get(s).applyAsInt(number) : number;
    }
